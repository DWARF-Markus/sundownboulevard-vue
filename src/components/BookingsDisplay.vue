<template>
  <div class="bookings-container">
    <div :class="{ 'bookings-header--dark' : getDarkMode }" class="bookings-header px-1 m-1">
      <p>
...
export default {
  ...
  computed: {
    ...mapGetters(["getMultipleBookings", "getEmail", "getDarkMode"])
  },
  created() {
