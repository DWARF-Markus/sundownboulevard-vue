	...
	<div>
		<div v-if="!loading" class="confirm-display-wrapper">
			<div class="confirm-display-container opacity-animation p-2">
				<div
					class="input-pair"
					:class="{ disabled: getBookingType === 'updateBooking' }"
				>
					<InputLabel
						@input="validateEmail"
						:value="email"
				...
				<div class="input-pair confirm-container">
					<label v-if="showDateTimeError" class="blue-text"
						>Please select a valid time for visiting</label
					>
				</div>
